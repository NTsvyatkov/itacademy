...
Order.add_order(1,date.today(),2,2,'Some City Some Street',50,'Comments1')
Order.add_order(3,date.today(),1,1,'Some City Some Street',30,'Comments2')
Order.add_order(2,date.today(),1,2,'Some City Some Street',15,'Comments3')
Order.add_order(4,date.today(),3,2,'Some City Some Street',111.50,'Comments4')
Order.add_order(2,date.today(),3,3,'Some City Some Street',21,'Comments5')
Order.add_order(1,date.today(),2,3,'Some City Some Street',31,'Comments46')
