...
UserDao.createNewUser('Max', '111','Maxim','Sidorov', 'max.sidorov@gmail.ru',1,2,1)
UserDao.createNewUser('Nikol', '111','Nikolay','Lobanov', 'giman89@gmail.ru', 4,1,1)
UserDao.createNewUser('Vanya', '111','Ivan','Ivanov', 'vanya@gmail.com', 2,1,1)
UserDao.createNewUser('Andrew', '111','Andrew','Petrov', 'andrew@mail.ru', 3,4,1)
UserDao.createNewUser('Katya', '111','Ekaterina','Ivanova', 'ekaterina@rambler.com', 4,3,1)
UserDao.createNewUser('Roma', '111','Roman','Melnishin', 'roma90@gmail.com', 2,1,1)
UserDao.createNewUser('Den', '111','Dennis','Popov', 'popov@mail.ru', 3,1,1)
UserDao.createNewUser('Max90', '111','Maxim','Smirnov', 'smirnov@gmail.ru', 4,4,1)
UserDao.createNewUser('Yaroslav', '111','Yaroslav','Lobanov', 'lobanov95@gmail.ru', 4,2,1)
UserDao.createNewUser('Seriy', '111','Sergey','Lobanov', 'global85@gmail.ru', 1,2,1)
UserDao.createNewUser('Dona', '111','Donna','Popova', 'popova@mail.ru', 3,1,1)
...
Order.add_order(2,date.today(),2,3,42,2)
Order.add_order(3,date.today(),2,2,12,2)
Order.add_order(3,date.today(),1,1,43,1)
Order.add_order(3,date.today(),1,2,31,2)
Order.add_order(3,date.today(),3,2,53,1)
Order.add_order(3,date.today(),2,3,42,2)
Order.add_order(3,date.today(),2,3,42,2)
Order.add_order(3,date.today(),2,2,12,2)
Order.add_order(3,date.today(),1,1,43,1)
Order.add_order(3,date.today(),1,2,31,2)
