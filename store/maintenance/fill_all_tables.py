...
Order.add_order(1,date.today(),2,2,10)
Order.add_order(3,date.today(),1,1,30)
Order.add_order(2,date.today(),1,2,15)
Order.add_order(4,date.today(),3,2,65)
Order.add_order(2,date.today(),2,3,49)
Order.add_order(1,date.today(),2,3,80)
