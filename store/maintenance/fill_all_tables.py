...
UserDao.createNewUser('Max', '1111','Maxim','Sidorov', 'max.sidorov@gmail.ru',1,2)
UserDao.createNewUser('Nikol', '1111','Nikolay','Lobanov', 'giman89@gmail.ru', 4,1)
UserDao.createNewUser('Vanya', '1111','Ivan','Ivanov', 'vanya@gmail.com', 2,1)
UserDao.createNewUser('Andrew', '1111','Andrew','Petrov', 'andrew@mail.ru', 3,4)
UserDao.createNewUser('Katya', '1111','Ekaterina','Ivanova', 'ekaterina@rambler.com', 4,3)
UserDao.createNewUser('Roma', '1111','Roman','Melnishin', 'roma90@gmail.com', 2,1)
UserDao.createNewUser('Den', '1111','Dennis','Popov', 'popov@mail.ru', 3,1)
UserDao.createNewUser('Max90', '1111','Maxim','Smirnov', 'smirnov@gmail.ru', 4,4)
UserDao.createNewUser('Yaroslav', '1111','Yaroslav','Lobanov', 'lobanov95@gmail.ru', 4,2)
UserDao.createNewUser('Seriy', '1111','Sergey','Lobanov', 'global85@gmail.ru', 1,2)
UserDao.createNewUser('Dona', '1111','Donna','Popova', 'popova@mail.ru', 3,1)
