...
Order.add_order(6,date.today(),1,1,43,1)
Order.add_order(3,date.today(),1,2,31,2)
Order.add_order(6,date.today(),3,2,53,1)
Order.add_order(3,date.today(),2,3,42,2)
Order.add_order(6,date.today(),2,3,42,2)
Order.add_order(3,date.today(),2,2,12,2)
Order.add_order(3,date.today(),1,1,43,1)
Order.add_order(6,date.today(),1,2,31,2)
Order.add_order(6,date.today(),3,2,53,1)
Order.add_order(3,date.today(),2,3,42,2)
Order.add_order(6,date.today(),2,3,42,2)
...
OrderProduct.add_order_product(2,4,1,5, 1.2)
OrderProduct.add_order_product(4,11,2,1, 11.3)
OrderProduct.add_order_product(1,7,3,3, 2.5)
OrderProduct.add_order_product(4,3,3,2, 10.0)
OrderProduct.add_order_product(5,1,2,1, 1.5)
OrderProduct.add_order_product(5,5,2,5, 7.0)
OrderProduct.add_order_product(5,6,1,4, 11.0)
OrderProduct.add_order_product(5,7,3,2, 2.5)
OrderProduct.add_order_product(6,3,1,4, 10.0)
OrderProduct.add_order_product(4,2,1,2, 5.5)
OrderProduct.add_order_product(4,5,2,5, 7.0)
OrderProduct.add_order_product(4,6,1,4, 11.0)
OrderProduct.add_order_product(4,7,3,2, 2.5)
OrderProduct.add_order_product(4,11,1,1, 11.3)
